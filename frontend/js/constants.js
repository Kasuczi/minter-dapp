const contractAddress = "0xEA190D65a28AE5C51e0e891C44cb4C59DF396DcA"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the PolyMandrills NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The PolyMandrills NFT Project is a decentralized visual token based on most impresive humanoid animal!';
